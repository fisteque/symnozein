...
CONFIG = {
    ...
    "index_prev_path": "Reinterpretace_13/material_index_prev.json",
    "diff_path": "Reinterpretace_13/material_diff.md",
    "source_script": "scripts/update_material_index.py",
    "source_workflow": ".github/workflows/update_material_index.yml",
    "diff_title": "# Material diff",
    "diff_description": "Automaticky generovaný přehled posledních změn v materiálech Reinterpretace.",
}
