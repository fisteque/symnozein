...
MATERIAL_DIR = "Reinterpretace_13/material"
INDEX_FILE = "Reinterpretace_13/material_index.json"
SITEMAP_FILE = "Reinterpretace_13/sitemap_material.xml"
...
if __name__ == "__main__":
    print("📘 Generuji material_index.json a sitemap_material.xml...")
