...
Mac:
  silnější pracovní vrstva, překladač schopností, lokální výpočetní opora

Codex:
  technický dotek, repo, opravy, testy, patchování

GitHub:
  páska, audit, veřejná paměť

Noema:
  směr, význam, rozhodování, vztah, ověření
